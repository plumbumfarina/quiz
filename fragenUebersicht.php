...
<body>
	...
	<main>
        <h1 class="formTitle">Fragen</h1>
            ...
            <div stlye="text-align: center; width:100%;">
                    <button styke="width: 50%;" type="button" onclick="openPageFrageAdd(<?php echo $kartendeck_id ?>)" class="buttonGreen"> Hinzufügen </button>
            </div>
    </main>
